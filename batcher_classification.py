...
class Batch(object):
  """
  Class representing a minibatch of train/val/test examples.
  """
...
class ClaBatcher(object):
    '''
    Classification을 위한 Batcher
    '''
    def __init__(self, hps, vocab):
        self._vocab = vocab
        self._hps = hps

        # train-original/ test-original/ 에서 데이터를 불러옴. weight 정보 등이 들어가 있지 않은 데이터.
        self.train_queue = self.fill_example_queue("train-original/*")
        self.test_queue = self.fill_example_queue("test-original/*")
