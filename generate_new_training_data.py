    ...
    def generate_training_example(self, training_dir):
        ...
        for step in range(len(self.batches)):
            ...
            for i in range(FLAGS.batch_size):
                ...
                self.write_negtive_to_json(positive_dir=training_dir,
                                           original_review=original_review,
                                           score=score,
                                           reward=decode_result['y_pred_auc'][i],
                                           # 여기서는 auc값을 초기 reward로 사용. 즉 논문에서 이야기하는 Sentiment confidence 임
                                           weight=decode_result['weight'][i],
                                           counter=counter)
