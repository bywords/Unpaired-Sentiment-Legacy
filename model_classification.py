...
class Classification(object):
    ...
    def _add_placeholders(self):
        ...
        # encoder part
        # Q. 왜 encoding인데 max_enc_steps가 아니라 max_dec_steps를 사용하는가?
    ...
    def _build_model(self):
        ...
        with tf.variable_scope('classification'):
            # rand_unif_init_mag: magnitude for lstm cells random uniform inititalization
            ...
            context, self.atten_weight = self.attention(fw_st.h, encoder_vector, hps.hidden_dim,
                                                        self._enc_padding_mask, hps)
            self.atten_weight = self.atten_weight*(-1)+1 # why?
    ...
    def _add_train_op(self):
        ...
        # Why tf.gradients? clipped gradients
